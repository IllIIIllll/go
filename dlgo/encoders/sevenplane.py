...
# 1. 활로가 1인 백돌은 1, 나머지는 0인 평면
# 2. 활로가 2인 백돌은 1, 나머지는 0인 평면
# 3. 활로가 3인 백돌은 1, 나머지는 0인 평면
# 4. 활로가 1인 흑돌은 1, 나머지는 0인 평면
# 5. 활로가 2인 흑돌은 1, 나머지는 0인 평면
# 6. 활로가 3인 흑돌은 1, 나머지는 0인 평면
# 7. 패가 발생해서 움직이지 못하는 돌이 1인 평면
