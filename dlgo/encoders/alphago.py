...
# 특징                 평면 수         설명
# 돌 색                3               현재 선수 / 상대 / 바둑판의 빈 점
# 1                    1               1로 꽉 찬 평면
# 0                    1               0으로 꽉찬 평면
# 가능한 수            1               가능한 수이면서 현재 선수의 눈을 채우면 0, 채우지 않으면 1
# 몇 수 전의 수        8               8개의 이항 평면으로 어떤 수가 놓인 후 몇 수가 지났는지
# 활로                 8               이 수와 관련된 이음의 활로
# 수 이후의 활로       8               이 수를 두었을 때 생기는 활로
# 따낸 돌의 수         8               이 수를 두었을 때 따낼 수 있는 돌의 수
# 자충수               8               이 수를 두었을 때 단수 상태에 빠지는 돌과 잡힐 돌
# 축잡기               1               축으로 잡히는지
# 축에서 벗어남        1               축에서 벗어나는지
# 현재 선수            1               현재 선수가 흑이면 1, 백이면 0
